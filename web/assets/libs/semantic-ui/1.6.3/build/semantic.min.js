define("bootstrap/3.2.0/js/bootstrap-debug", ["jquery"], function (require, exports, module) {
    var jQuery = require("jquery");
    (function ($, window, document, undefined) {
        $.site = $.fn.site = function (parameters) {
            var time = (new Date).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.site.settings, parameters) : $.extend({}, $.site.settings), namespace = settings.namespace, error = settings.error, eventNamespace = "." + namespace, moduleNamespace = "module-" + namespace, $document = $(document), $module = $document, element = this, instance = $module.data(moduleNamespace), module, returnedValue;
            module = {
                initialize: function () {
                    module.instantiate()
                ...
                }, cache: {}, setting: function (name, value) {
                    ...
                    initialize: function () {
                        ...
                        field: {
                            keydown: function (event) {
                                var $field = $(this), key = event.which, keyCode = {enter: 13, escape: 27};
            ...
            $allModules.each(function () {
                ...
                module = {
                    initialize: function () {
                        ...
                        var $activeTitle = query !== undefined ? typeof query === "number" ? $title.eq(query) : $(query) : $(this), $activeContent = $activeTitle.next($content), contentIsOpen = $activeContent.is(":visible");
                        ...
                        var $activeTitle = query !== undefined ? typeof query === "number" ? $title.eq(query) : $(query) : $(this), $activeContent = $activeTitle.next($content), currentlyAnimating = $activeContent.is(":animated"), currentlyActive = $activeContent.hasClass(className.active);
                        if (!currentlyAnimating && !currentlyActive) {
                            ...
                            if (settings.animateChildren) {
                                if ($.fn.transition !== undefined && $module.transition("is supported")) {
                                    ...
                                    $activeContent.children().stop().animate({opacity: 1}, settings.duration, module.resetOpacity)
                                }
                            }
                            $activeContent.stop().slideDown(settings.duration, settings.easing, function () {
                        ...
                        var $activeTitle = query !== undefined ? typeof query === "number" ? $title.eq(query) : $(query) : $(this), $activeContent = $activeTitle.next($content), isActive = $activeContent.hasClass(className.active);
                        if (isActive) {
                            ...
                            if (settings.animateChildren) {
                                if ($.fn.transition !== undefined && $module.transition("is supported")) {
                                    ...
                                    $activeContent.children().stop().animate({opacity: 0}, settings.duration, module.resetOpacity)
                                }
                            }
                            $activeContent.stop().slideUp(settings.duration, settings.easing, function () {
                                $.proxy(module.reset.display, this)();
                        ...
                        if ($openTitles.size() > 0) {
                            ...
                            if (settings.animateChildren) {
                                if ($.fn.transition !== undefined && $module.transition("is supported")) {
                                    ...
                                    $openContents.children().stop().animate({opacity: 0}, settings.duration, module.resetOpacity)
                                }
                            }
            ...
            $allModules.each(function () {
                ...
                module = {
                    initialize: function () {
                        ...
                        keydown: function (event) {
                            var key = event.which, keyCode = {enter: 13, escape: 27};
                            if (key == keyCode.escape) {
                                module.verbose("Escape key pressed blurring field");
                                $module.blur()
                            }
            ...
            $allModules.each(function () {
                ...
                module = {
                    initialize: function () {
                        ...
                        var $results = $(), exactRegExp = new RegExp("^" + searchTerm, "igm"), fullTextRegExp = new RegExp(searchTerm, "ig"), allItemsFiltered;
                        ...
                        mousedown: function () {
                            ...
                            var $selectedItem = $item.not(className.filtered).filter("." + className.selected).eq(0), $visibleItems = $item.not("." + className.filtered), pressedKey = event.which, keys = {
                                enter: 13,
                                escape: 27,
                                upArrow: 38,
                                downArrow: 40
                            }, selectedClass = className.selected, currentIndex = $visibleItems.index($selectedItem), hasSelectedItem = $selectedItem.size() > 0, $nextItem, newIndex;
                            if (!hasSelectedItem) {
                            ...
                            mouseenter: function (event) {
                                var $currentMenu = $(this).children(selector.menu), $otherMenus = $(this).siblings(selector.item).children(selector.menu);
                                ...
                                var $choice = $(this), $target = $(event.target), $subMenu = $choice.find(selector.menu), text = module.get.choiceText($choice), value = module.get.choiceValue($choice, text), callback = function () {
                                    module.remove.searchTerm();
                                    module.determine.selectAction(text, value)
                                }, openingSubMenu = $subMenu.size() > 0, isSubItem = $subMenu.find($target).size() > 0;
                                if (isSubItem) {
                                    return false
                                }
                        ...
                        text: function () {
                            ...
                            if ($choice !== undefined) {
                                ...
                                return $choice.data(metadata.text) !== undefined ? $choice.data(metadata.text) : preserveHTML ? $choice.html() : $choice.text()
                            }
                        }, choiceValue: function ($choice, choiceText) {
                            choiceText = choiceText || module.get.choiceText($text);
                            return $choice.data(metadata.value) !== undefined ? $choice.data(metadata.value) : typeof choiceText === "string" ? choiceText.toLowerCase() : choiceText
                        }, inputEvent: function () {
                            var input = $search[0];
                            if (input) {
                            ...
                            $module.find("option").each(function () {
                                ...
                                if (value === "") {
                                    ...
                                    if (settings.sortSelect) {
                                        select.values[value] = {name: name, value: value}
                                    } else {
                                        select.values.push({name: name, value: value})
                                    }
                                }
                            });
                            if (settings.sortSelect) {
                        ...
                        filtered: function () {
                            var searchValue = $search.val(), hasSearchValue = typeof searchValue === "string" && searchValue.length > 0;
                            if (hasSearchValue) {
                            ...
                            var edgeTolerance = 5, hasActive, offset, itemHeight, itemOffset, menuOffset, menuScroll, menuHeight, abovePage, belowPage;
                        ...
                        show: function (callback, $subMenu) {
                            ...
                            if (module.is.hidden($currentMenu) || module.is.animating($currentMenu)) {
                                if (settings.transition == "none") {
                                    ...
                                    start();
                                    $currentMenu.hide().clearQueue().children().clearQueue().css("opacity", 0).delay(50).animate({opacity: 1}, settings.duration, "easeOutQuad", module.event.resetStyle).end().slideDown(100, "easeOutQuad", function () {
                            ...
                            var $currentMenu = $subMenu || $menu, duration = $subMenu ? settings.duration * .9 : settings.duration, start = $subMenu ? function () {
                            } : function () {
                                if (module.can.click()) {
                            ...
                            if (module.is.visible($currentMenu) || module.is.animating($currentMenu)) {
                                ...
                                if (settings.transition == "none") {
                                    ...
                                    start();
                                    $currentMenu.show().clearQueue().children().clearQueue().css("opacity", 1).animate({opacity: 0}, 100, "easeOutQuad", module.event.resetStyle).end().delay(50).slideUp(100, "easeOutQuad", function () {
                                        $.proxy(module.event.resetStyle, this)();
                                        $.proxy(callback, element)()
                                    })
                                } else if (settings.transition == "fade") {
                    ...
                    initialize: function () {
                        ...
                        dimmer: function () {
                            var defaultSettings = {
                                debug: settings.debug,
                                dimmerName: "modals",
                                duration: {show: settings.duration, hide: settings.duration}
                        ...
                        autofocus: function () {
                            if (settings.autofocus) {
                                var $inputs = $module.find(":input:visible"), $autofocus = $inputs.filter("[autofocus]"), $input = $autofocus.size() > 0 ? $autofocus : $inputs;
                                $input.first().focus()
                            }
                        }, clickaway: function () {
                            if (settings.closable) {
                            ...
                            if (module.can.fit()) {
                                $module.css({top: "", marginTop: -(module.cache.height / 2)})
                            } else {
                                $module.css({marginTop: "", top: $document.scrollTop()})
                            }
                        }
                    }, setting: function (name, value) {
                        module.debug("Changing setting", name, value);
    ...
    (function ($, window, document, undefined) {
        ...
        $.fn.popup = function (parameters) {
            var $allModules = $(this), $document = $(document), moduleSelector = $allModules.selector || "", hasTouch = "ontouchstart"in document.documentElement, time = (new Date).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
            $allModules.each(function () {
                var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.popup.settings, parameters) : $.extend({}, $.fn.popup.settings), selector = settings.selector, className = settings.className, error = settings.error, metadata = settings.metadata, namespace = settings.namespace, eventNamespace = "." + settings.namespace, moduleNamespace = "module-" + namespace, $module = $(this), $context = $(settings.context), $target = settings.target ? $(settings.target) : $module, $window = $(window), $body = $("body"), $popup, $offsetParent, searchDepth = 0, triedPositions = false, element = this, instance = $module.data(moduleNamespace), module;
                module = {
                    initialize: function () {
                        ...
                        if (html || content || title) {
                            ...
                            if (!html) {
                                html = settings.templates.popup({title: title, content: content})
                            }
                        ...
                        if (settings.inline || settings.popup) {
                            ...
                            return $popup.closest($context).size() > 1 ? true : false
                        }
                        ...
                        startEvent: function () {
                            ...
                            var position = position || false, boundary = {
                            ...
                            var positions = position.split(" "), verticalPosition = positions[0], horizontalPosition = positions[1], opposite = {
                                ...
                                left: "right",
                                right: "left"
                            }, adjacent = {left: "center", center: "right", right: "left"}, backup = {
                                "top left": "top center",
            ...
            $allModules.each(function () {
                ...
                module = {
                    initialize: function () {
                        ...
                        var total = module.total || false, edgeValue, startValue, newValue;
                        if (total) {
                        ...
                        var total = module.total || false, edgeValue = 0, startValue, newValue;
                        if (total) {
                            startValue = module.value || 0;
                        ...
                        text: function (templateText) {
                            var value = module.value || 0, total = module.total || 0, percent = module.is.visible() && animating ? module.get.displayPercent() : module.percent || 0;
                        ...
                        barWidth: function (value) {
                            ...
                            var numericValue = typeof value === "string" ? value.replace(/[^\d.]/g, "") !== "" ? +value.replace(/[^\d.]/g, "") : false : value, percentComplete;
                ...
                module = {
                    initialize: function () {
                        ...
                        mouseenter: function () {
                            ...
                            var $activeIcon = $(this), currentRating = module.getRating(), rating = $icon.index($activeIcon) + 1, canClear = settings.clearable == "auto" ? $icon.size() === 1 : settings.clearable;
            ...
            $(this).each(function () {
                ...
                module = {
                    initialize: function () {
                        ...
                        var $result = $module.find(selector.result), $category = $module.find(selector.category), keyCode = event.which, keys = {
                            backspace: 8,
                            enter: 13,
                            escape: 27,
                            upArrow: 38,
                        ...
                        cancel: function () {
                            ...
                            if (cachedHTML) {
                                ...
                                if ($.isPlainObject(settings.source) || $.isArray(settings.source)) {
                                    ...
                                    settings.apiSettings = {action: "search"};
                                    module.search.remote(searchTerm)
                                } else {
                            ...
                            searchHTML = module.results.generate({results: $.merge(results, fullTextResults)});
                        ...
                        generate: function (response) {
                            ...
                            if (settings.onSelect == "default" || $.proxy(settings.onSelect, this)(event) == "default") {
                                var $link = $result.find("a[href]").eq(0), $title = $result.find(selector.title).eq(0), href = $link.attr("href") || false, target = $link.attr("target") || false, name = $title.size() > 0 ? $title.text() : false;
                                module.results.hide();
                                if (name) {
                                    $prompt.val(name)
                                }
    ...
    (function ($, window, document, undefined) {
        ...
        $.fn.shape = function (parameters) {
            ...
            $allModules.each(function () {
                var moduleSelector = $allModules.selector || "", settings = $.extend(true, {}, $.fn.shape.settings, parameters), namespace = settings.namespace, selector = settings.selector, error = settings.error, className = settings.className, eventNamespace = "." + namespace, moduleNamespace = "module-" + namespace, $module = $(this), $sides = $module.find(selector.sides), $side = $module.find(selector.side), nextIndex = false, $activeSide, $nextSide, element = this, instance = $module.data(moduleNamespace), module;
                module = {
                    initialize: function () {
                        ...
                        defaultSide: function () {
                            ...
                            var $clone = $module.clone().addClass(className.loading), $activeSide = $clone.find("." + settings.className.active), $nextSide = nextIndex ? $clone.find(selector.side).eq(nextIndex) : $activeSide.next(selector.side).size() > 0 ? $activeSide.next(selector.side) : $clone.find(selector.side).first(), newSize = {};
                            $activeSide.removeClass(className.active);
                            $nextSide.addClass(className.active);
                            $clone.insertAfter($module);
                            newSize = {width: $nextSide.outerWidth(), height: $nextSide.outerHeight()};
                            $clone.remove();
                            $module.css(newSize);
                        ...
                        transform: {
                            up: function () {
                                ...
                                var translate = {x: -(($activeSide.outerWidth() - $nextSide.outerWidth()) / 2)};
                        ...
                        above: function () {
                            var box = {
                                ...
                                depth: {active: $nextSide.outerHeight() / 2, next: $activeSide.outerHeight() / 2}
                            };
                            ...
                            var box = {
                                ...
                                depth: {active: $nextSide.outerWidth() / 2, next: $activeSide.outerWidth() / 2}
                            };
    ...
    (function ($, window, document, undefined) {
        ...
        $.fn.sidebar = function (parameters) {
            var $allModules = $(this), $window = $(window), $document = $(document), $html = $("html"), $head = $("head"), moduleSelector = $allModules.selector || "", time = (new Date).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function (callback) {
                    setTimeout(callback, 0)
                }, returnedValue;
            $allModules.each(function () {
                var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.sidebar.settings, parameters) : $.extend({}, $.fn.sidebar.settings), selector = settings.selector, className = settings.className, namespace = settings.namespace, regExp = settings.regExp, error = settings.error, eventNamespace = "." + namespace, moduleNamespace = "module-" + namespace, $module = $(this), $context = $(settings.context), $sidebars = $module.children(selector.sidebar), $pusher = $context.children(selector.pusher), $style, element = this, instance = $module.data(moduleNamespace), elementNamespace, id, currentScroll, transitionEvent, module;
                module = {
                    initialize: function () {
                        ...
                        bodyCSS: function (direction, distance) {
                            var width = $module.outerWidth(), height = $module.outerHeight(), style;
                        ...
                        var $otherSidebars = $sidebars.not($module).filter("." + className.visible), callback = callback || function () {
                            }, sidebarCount = $otherSidebars.size(), callbackCount = 0;
                        ...
                        var transition = module.get.transition(), $transition = transition == "safe" ? $context : transition == "overlay" || module.othersVisible() ? $module : $pusher, animate, transitionEnd;
                        callback = $.isFunction(callback) ? callback : function () {
                        };
                        ...
                        var distance = $module.width(), direction = module.get.direction(), properties = {};
                        ...
                        var distance = 0, direction = module.get.direction(), properties = {};
                        distance = distance || $module.width();
                        callback = $.isFunction(callback) ? callback : function () {
                        };
                        ...
                        ie: function () {
                            var isIE11 = !window.ActiveXObject && "ActiveXObject"in window, isIE = "ActiveXObject"in window;
                            return isIE11 || isIE
                        }, legacy: function () {
                            var element = document.createElement("div"), transforms = {
                            ...
                            var userAgent = navigator.userAgent, isIOS = regExp.ios.test(userAgent);
                            if (isIOS) {
                            ...
                            var userAgent = navigator.userAgent, isMobile = regExp.mobile.test(userAgent);
                            if (isMobile) {
    ...
    (function ($, window, document, undefined) {
        ...
        $.fn.sticky = function (parameters) {
            var $allModules = $(this), moduleSelector = $allModules.selector || "", time = (new Date).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
            $allModules.each(function () {
                var settings = $.extend(true, {}, $.fn.sticky.settings, parameters), className = settings.className, namespace = settings.namespace, error = settings.error, eventNamespace = "." + namespace, moduleNamespace = "module-" + namespace, $module = $(this), $window = $(window), $container = $module.offsetParent(), $scroll = $(settings.scrollContext), $context, selector = $module.selector || "", instance = $module.data(moduleNamespace), requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function (callback) {
                        setTimeout(callback, 0)
                ...
                module = {
                    initialize: function () {
                        ...
                        sticky: function () {
                            var $element = $("<div/>"), element = $element.get();
                        ...
                        direction: function (scroll) {
                            ...
                            scroll = scroll || $scroll.scrollTop();
                            var element = module.cache.element, window = module.cache.window, delta = module.get.scrollChange(scroll), maxScroll = element.height - window.height + settings.offset, currentScroll = module.get.currentElementScroll(), possibleScroll = currentScroll + delta, elementScroll;
                        ...
                        offset: function () {
                            ...
                            if (module.cache.element.height !== 0 && module.cache.element.width !== 0) {
                                $module.css({width: module.cache.element.width, height: module.cache.element.height})
                            }
                        }
                    }, is: {
                        top: function () {
                        ...
                        var cache = module.cache, fits = cache.fits, element = cache.element, window = cache.window, context = cache.context, offset = module.is.bottom() && settings.pushing ? settings.bottomOffset : settings.offset, scroll = {
                            top: $scroll.scrollTop() + offset,
                            bottom: $scroll.scrollTop() + offset + window.height
                        }, direction = module.get.direction(scroll.top), elementScroll = module.get.elementScroll(scroll.top), doesntFit = !fits, elementVisible = element.height !== 0;
                        ...
                        $module.css({top: "", bottom: "", width: "", height: ""});
                ...
                module = {
                    initialize: function () {
                        ...
                        if (settings.auto) {
                            ...
                            settings.apiSettings = {url: settings.path + "/{$tab}"}
                        }
                        if (!$.isWindow(element)) {
    ...
    (function ($, window, document, undefined) {
        ...
        $.fn.transition = function () {
            ...
            $allModules.each(function () {
                var $module = $(this), element = this, settings, instance, error, className, metadata, animationStart, animationEnd, animationName, namespace, moduleNamespace, eventNamespace, module;
                module = {
                    initialize: function () {
                        ...
                        animating: function (animation) {
                            ...
                            var style = module.get.style(), displayType = module.get.displayType(), overrideStyle = style + "display: " + displayType + " !important;";
                            $module.css("display", "");
                            module.refresh();
                        ...
                        displayType: function (displayType) {
                            ...
                            var clasName = $module.attr("class") || false, style = $module.attr("style") || "";
                            $module.removeClass(settings.animation);
                            module.remove.direction();
                            module.cache = {className: $module.attr("class"), style: module.get.style()};
                        ...
                        settings: function (animation, duration, onComplete) {
                            ...
                            duration = duration || settings.duration;
                            return typeof settings.duration === "string" ? duration.indexOf("ms") > -1 ? parseFloat(duration) : parseFloat(duration) * 1e3 : duration
                        ...
                        transition: function (forced) {
                            var elementClass = $module.attr("class"), tagName = $module.prop("tagName"), animation = settings.animation, transitionExists = module.get.transitionExists(animation), $clone, currentAnimation, inAnimation, directionExists, displayType;
                ...
                module = {
                    initialize: function () {
                        ...
                        html: function (source, id, url) {
                            ...
                            var api = settings.api ? 1 : 0, autoplay = settings.autoplay === "auto" ? $module.data("image") !== undefined : settings.autoplay, hd = settings.hd ? 1 : 0, showUI = settings.showUI ? 1 : 0, hideUI = !settings.showUI ? 1 : 0, url = "";
                            if (source == "vimeo") {
    ...
    (function ($, window, document, undefined) {
        $.api = $.fn.api = function (parameters) {
            var $allModules = $.isFunction(this) ? $(window) : $(this), moduleSelector = $allModules.selector || "", time = (new Date).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
            $allModules.each(function () {
                var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.api.settings, parameters) : $.extend({}, $.fn.api.settings), namespace = settings.namespace, metadata = settings.metadata, selector = settings.selector, error = settings.error, className = settings.className, eventNamespace = "." + namespace, moduleNamespace = "module-" + namespace, $module = $(this), $form = $module.closest(selector.form), $context = settings.stateContext ? $(settings.stateContext) : $module, ajaxSettings, requestSettings, url, data, element = this, context = $context.get(), instance = $module.data(moduleNamespace), module;
                module = {
                    initialize: function () {
                        ...
                        trigger: function (event) {
                            ...
                            always: function () {
                                ...
                                var context = this, elapsedTime = (new Date).getTime() - time, timeLeft = settings.loadingDuration - elapsedTime;
                            ...
                            complete: function (response) {
                                ...
                                var errorMessage = settings.error[status] !== undefined ? settings.error[status] : httpMessage, response;
                                if (xhr !== undefined) {
    ...
    (function ($, window, document, undefined) {
        $.fn.state = function (parameters) {
            var $allModules = $(this), moduleSelector = $allModules.selector || "", hasTouch = "ontouchstart"in document.documentElement, time = (new Date).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
            $allModules.each(function () {
        ...
        $.fn.state.settings = {
            ...
            selector: {text: false},
            defaults: {
                input: {disabled: true, loading: true, active: true},
                button: {disabled: true, loading: true, active: true},
                progress: {active: true, success: true, warning: true, error: true}
            },
            states: {active: true, disabled: true, error: true, loading: true, success: true, warning: true},
            text: {
                disabled: false,
                flash: false,
                hover: false,
    ...
    (function ($, window, document, undefined) {
        $.fn.visibility = function (parameters) {
            var $allModules = $(this), moduleSelector = $allModules.selector || "", time = (new Date).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
            $allModules.each(function () {
                var settings = $.extend(true, {}, $.fn.visibility.settings, parameters), className = settings.className, namespace = settings.namespace, error = settings.error, eventNamespace = "." + namespace, moduleNamespace = "module-" + namespace, $window = $(window), $module = $(this), $context = $(settings.context), $container = $module.offsetParent(), selector = $module.selector || "", instance = $module.data(moduleNamespace), requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function (callback) {
                        setTimeout(callback, 0)
                    }, element = this, module;
                module = {
                    initialize: function () {
                        ...
                        var imagesLength = images.length, loadedCounter = 0, cache = [], cacheImage = document.createElement("img"), handleLoad = function () {
                            loadedCounter++;
                        ...
                        cache: function () {
                            module.cache = {occurred: {}, screen: {}, element: {}}
                        }, image: function () {
                            ...
                            $module.visibility({
                                once: false, continuous: false, onTopPassed: function () {
                                    ...
                                    $module.removeClass(className.fixed).css({position: "", top: ""})
                                }
                            })
                        }
                    }, set: {
                        ...
                        calculations: function () {
                            ...
                            module.save.direction();
                            $.extend(module.cache.screen, {top: scroll, bottom: scroll + module.cache.screen.height});
