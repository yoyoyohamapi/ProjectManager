...
class FOSRestExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConfigLoad()
    {
        ...
        $this->assertEquals(
            $yamlCollectionLoaderClass,
            $this->container->getParameter($yamlCollectionLoaderClassParameter)
        );
        ...
        $this->assertEquals(
            $xmlCollectionLoaderClass,
            $this->container->getParameter($xmlCollectionLoaderClassParameter)
        );
    ...
    {
        $this->extension->load(
            array('fos_rest' => array('view' => array('jsonp_handler' => array('callback_filter' => 'foo')))),
            $this->container
        );
    }
}
