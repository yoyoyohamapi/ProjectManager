...
class BodyListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testOnKernelRequest(
        ...
        $decoder = $this->getMockBuilder('FOS\RestBundle\Decoder\DecoderInterface')->disableOriginalConstructor(
        )->getMock();
    ...
    {
        return array(
            'Empty POST request' => array(
                true,
                new Request(array(), array(), array(), array(), array(), array(), array('foo')),
                'POST',
                array('foo'),
                'application/json'
            ),
            'Empty PUT request' => array(
                true,
                new Request(array(), array(), array(), array(), array(), array(), array('foo')),
                'PUT',
                array('foo'),
            ...
            'POST request with parameters' => array(
                false,
                new Request(
                    array(),
                    array('bar'),
            ...
            'POST request with unallowed format' => array(
                false,
                new Request(array(), array(), array(), array(), array(), array(), array('foo')),
                'POST',
                array(),
                'application/fooformat'
            ),
            'POST request with no Content-Type' => array(
                true,
                new Request(array(), array(), array('_format' => 'json'), array(), array(), array(), array('foo')),
                'POST',
                array('foo')
            ),
        );
    ...
    public function testBadRequestExceptionOnMalformedContent()
    {
        ...
        $this->testOnKernelRequest(
            true,
            new Request(array(), array(), array(), array(), array(), array(), 'foo'),
            'POST',
            array(),
            'application/json'
        );
