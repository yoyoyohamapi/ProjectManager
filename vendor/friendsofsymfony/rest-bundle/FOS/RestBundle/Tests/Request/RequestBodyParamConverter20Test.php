...
class RequestBodyParamConverter20Test extends AbstractRequestBodyParamConverterTest
{
    ...
    public function setUp()
    {
        ...
        if ('Sensio\Bundle\FrameworkExtraBundle\Configuration\ConfigurationInterface' != $parameter->getClass(
            )->getName()
        ) {
    ...
    public function testApplyWithValidationErrors()
    {
        ...
        $this->converter = new RequestBodyParamConverter20(
            $this->serializer, null, null, $validator, 'validationErrors'
        );
